...
@EnableJpaRepositories(
        ...
        basePackages = "com.Dev.CreateEstimatingPlan.repository.studentsRepository",
        transactionManagerRef = "postgresTransactionManager"
)
public class DatabaseConfigurationStudents {
    /****
    ...
    public LocalContainerEntityManagerFactoryBean postgresEntityManager(
        ...
        return entityManagerFactoryBuilder
                ...
                .packages("com.Dev.CreateEstimatingPlan.entity.students")
                .persistenceUnit("student_group")
